...
stats_process=subprocess.Popen(["python3","-u", "check_after_one_run.py", f"./dataAll/N{N}/T{TStr}/run_T{TStr}.mc.conf",str(startingFileIndSuggest)], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
while True:
